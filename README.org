...
|------+--------------------+----------------------------|
|    1 | Instructor         | 0.1 [[file+sys:./cmpnt-orientation/0.w1AcademicOrientation.pdf][Academic Orientation]]   |
...
#+ATTR_REVEAL: :frag (appear appear appear ...)
- [[https://akts.yeditepe.edu.tr/web/Ects/CourseDetail?PID=207&BID=182&Y=1&Z=Z&G=1&DID=5184][Bologna Syllabus]]
